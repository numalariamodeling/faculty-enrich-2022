...
def diagnostic_survey(cb, sim_day, thresh=5000, dose=1):
    '''
    defines diagnostic surveys to be reported
    :param cb: model builder
    :type cb: builder
    '''
    add_diagnostic_survey(cb, start_day=sim_day,
                          ...
                          positive_diagnosis_configs=[{'class': 'BroadcastEvent',
                                                       'Broadcast_Event': f'Day_0_greater_than_{thresh}'}],
                          negative_diagnosis_configs=[{'class': 'BroadcastEvent',
                                                       'Broadcast_Event': f'Day_0_less_than_{thresh}'}]
                          ),
    # upper threshold diagnostic
    add_diagnostic_survey(cb, start_day=sim_day,
                          diagnostic_threshold=200000,
                          trigger_condition_list=[f'Received_IPTi_{dose}'],  # 'Received_IPTi'],
                          positive_diagnosis_configs=[{'class': 'BroadcastEvent',
                                                       'Broadcast_Event': 'Day_0_greater_than_200000'}],
                          negative_diagnosis_configs=[{'class': 'BroadcastEvent',
                                                       'Broadcast_Event': 'Day_0_less_than_200000'}]
                          ),
    # day 0 positivity
    add_diagnostic_survey(cb, start_day=sim_day,
    ...
    add_diagnostic_survey(cb, start_day=sim_day,
                          ...
                          trigger_condition_list=[f'Received_IPTi_{dose}'],
                          positive_diagnosis_configs=[{'class': 'BroadcastEvent',
                                                       'Broadcast_Event': 'Day_14_positive'}],
                          negative_diagnosis_configs=[{'class': 'BroadcastEvent',
                                                       'Broadcast_Event': 'Day_14_negative'}],
